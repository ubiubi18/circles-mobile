  ...
  async signInWithGoogleAsync () {
    try {
      const result = await Google.logInAsync({
        ...
        androidStandaloneAppClientId: '965483631176-hjcvrlaj7ho34e3nijjenq58e7ducsop.apps.googleusercontent.com',
        iosStandaloneAppClientId: '965483631176-jbub70ofps7nambgd8dtdlvqu15sg4d3.apps.googleusercontent.com',
        scopes: ['profile']
      })
      ...
      <View style={{flex: 1, alignItems: 'center'}}>
        ...
        >
          <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
            <Image style={{height: 148, width: calculateWidthRatio(146), marginTop: calculateHeightRatio(98), resizeMode: 'contain'}} source={require('circles-mobile/images/logo.png')} />
          </View>
